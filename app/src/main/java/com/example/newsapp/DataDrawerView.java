...
public class DataDrawerView extends View {
    ...
    public DataDrawerView(Context context) {
        super(context);
    }

    //在构造方法中传入横列的刻度值数组、竖列的刻度值数组、画笔颜色集合、柱状图高度数值数组
    public DataDrawerView(Context context, String[] transverse, String[] vertical, List<Integer> colors, int[] high) {
        super(context);
